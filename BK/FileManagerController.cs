...
using ManagementSystem.Areas.Backoffice.Services;

namespace ManagementSystem.Areas.Backoffice.Controllers;

[Area("Backoffice")]
public class FileManagerController(FileManagerServices svc) : Controller
{

...
public partial class HnbHnbBackofficeDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<system_config>(entity =>
        {
            ...
            entity.Property(e => e.cpu_usage).HasComment("CPU 使用率 (JSON 格式)");
            ...
            entity.Property(e => e.debug_mode)
                .HasDefaultValue(false)
                .HasComment("偵錯模式");
            entity.Property(e => e.disk_usage).HasComment("磁碟使用率 (JSON 格式)");
            ...
            entity.Property(e => e.memory_usage).HasComment("記憶體使用率 (JSON 格式)");

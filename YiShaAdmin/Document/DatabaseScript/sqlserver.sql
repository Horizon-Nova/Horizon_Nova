...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'登入次數',                                 @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'SysUser', @level2type=N'COLUMN',@level2name=N'LoginCount'
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'首次登入時間',								 @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'SysUser', @level2type=N'COLUMN',@level2name=N'FirstVisit'
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'上一次登入時間',						     @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'SysUser', @level2type=N'COLUMN',@level2name=N'PreviousVisit'
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最後一次登入時間',                          @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'SysUser', @level2type=N'COLUMN',@level2name=N'LastVisit'

...
namespace YiSha.Util
{
    ...
    {
        #region  驗證輸入字符串為數字(帶小數)
        /// <summary>
        /// 驗證輸入字符串為帶小數點正數
        /// </summary>
        /// <param name="str">輸入字符</param>
        ...
        #region 驗證中国電話格式是否有效，格式010-85849685
        /// <summary>
        /// 驗證中国電話格式是否有效，格式010-85849685
        /// </summary>
        /// <param name="str">輸入字符</param>
        /// <returns>返回一個bool類型的值</returns>
        ...
        #region 驗證手機號是否合法
        /// <summary>
        /// 驗證手機號是否合法 號段為13,14,15,16,17,18,19  0，86開頭將自動識別
        /// </summary>
        /// <param name="str">輸入字符</param>
        /// <returns>返回一個bool類型的值</returns>
        ...
        #region 是否由數字、26個英文字母或者底線組成的字串
        /// <summary>
        /// 是否由數字、26個英文字母或者底線組成的字串 
        /// </summary>
        /// <param name="str">輸入字符</param>
        /// <returns></returns>
